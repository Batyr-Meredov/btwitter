...
class DeathCases:
    ...
    def fetch_time_series_covid19_death_global(self, country):
    ...
    def get_time_series_covid19_death_for_us(self, year='', month=''):
        df2 = self.fetch_time_series_covid19_death_global(country='US')
